        ...
        this._template = `
            <div class="row add__inputs-line">
                <div class="col-10">
                    <div class="row">
                        <div class="col-4">
                            <input type="text" disabled data-inputs-target-skill value="${data.name}">
                        </div>
                        <div class="col-4">
                            <input type="text" disabled data-inputs-target-detail value="${data.email}">
                        </div>
                        <div class="col-4">
                            <input type="text" disabled data-inputs-target-years value="${data.phone}">
                        </div>
                    </div>
                </div>
                <div class="col-2">
